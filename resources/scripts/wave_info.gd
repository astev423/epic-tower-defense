...
static var waves: Dictionary[int, Array] = {
	...
	3: [GameTypes.EnemyType.Weakling, 5, 0.2, GameTypes.EnemyType.Weakling, 1, 3,
	...
	11: [GameTypes.EnemyType.Weakling, 12, 0.1, GameTypes.EnemyType.Bubba, 2, 5.0,
			GameTypes.EnemyType.Weakling, 12, 0.1, GameTypes.EnemyType.Bubba, 2, 5.0],
	...
	15: [GameTypes.EnemyType.Bubba, 3, 5.0, GameTypes.EnemyType.Bubba, 1, 5.0,
			GameTypes.EnemyType.UltraTank, 1, 1.0],
	16: [GameTypes.EnemyType.Skeletor, 12, 0.5],
	17: [GameTypes.EnemyType.Skeletor, 12, 0.02],
	18: [GameTypes.EnemyType.Skeletor, 24, 0.02],
	50: [GameTypes.EnemyType.BossMan, 1, 1.0],
}
